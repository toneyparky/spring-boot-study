...
public class OAuthAttributes {
	...
	// OAuth2User에서 반환하는 사용자 정보는 Map이기에 값 하나하나를 반환해야한다.
	...
	public User toEntity() { // User 엔티티를 생성, OAuthAttributes에서 엔티티를 생성하는 시점은 처음 가입할 떄. 가입할 떄의 기본 권한을 GUEST로 주기 위해 빌더에 저걸 넣은 것.
		return User.builder()
				.name(name)
				.email(email)
				.picture(picture)
