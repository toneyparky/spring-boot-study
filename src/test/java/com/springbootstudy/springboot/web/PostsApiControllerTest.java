...
public class PostsApiControllerTest {
	...
	@Autowired
	private TestRestTemplate restTemplate; // HelloController 테스트와 달리 골뱅이WebMvcTest를 사용 안함. 이건 JPA기능이 작동 안해서 지금 같은 경우는 TestRestTemplate을 사용해야함.
	...
	public void Posts_등록된다() throws Exception {
		...
		//when
		mvc.perform(post(url) // mvc.perform() 생성된 MockMvc를 통해 API를 테스트한다. 본문영역은 문자열로 표현하기 위해 ObjectMapper를 통해 문자열 JSON으로 반환한다.
